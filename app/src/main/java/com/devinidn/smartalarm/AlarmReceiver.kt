...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, type: Int, time: String, message: String){
        ...
        val paddingIntent = PendingIntent.getBroadcast(context, 102, intent, 0)
    ...
    fun cancelAlarm(context: Context, type: Int){
        ...
        val intent = Intent(context, AlarmReceiver::class.java)
        // ambil requestCode / ID_ALARM berdasarkan tipe alarmnya
        ...
        if(type == TYPE_ONE_TIME){
            Toast.makeText(context, "successfully cancel ONR TIME ALARM", Toast.LENGTH_SHORT)
                .show()
        } else {
